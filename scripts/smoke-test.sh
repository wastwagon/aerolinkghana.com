#!/bin/bash
# Pre-production smoke test for AeroLink Ghana
...
PAGES=(
  ...
  "/corporate/brochure"
  "/blog"
  "/blog/kotoka-airport-to-hotel-accra"
  "/blog/first-timers-guide-accra-airport"
  "/booking/status"
  "/login"
  "/payment/callback"
  "/robots.txt"
...
PRICING='{"type":"PICKUP","vehicleId":"executive-sedan","pickupLocation":"Kotoka International Airport","dropoffLocation":"East Legon, Accra","passengerCount":2}'
...
BOOKING="{\"type\":\"PICKUP\",\"vehicleId\":\"executive-sedan\",\"pickupLocation\":\"Kotoka International Airport\",\"dropoffLocation\":\"East Legon, Accra\",\"pickupDate\":\"$FUTURE\",\"flightNumber\":\"KQ509\",\"passengerCount\":2,\"luggageCount\":1,\"customerName\":\"Test User\",\"customerEmail\":\"test@example.com\",\"customerPhone\":\"0555207204\",\"paymentMethod\":\"WHATSAPP\"}"
