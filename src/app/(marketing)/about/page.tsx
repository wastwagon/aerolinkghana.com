...
export const metadata: Metadata = createMetadata({
  title: "About Us",
  description:
    "Learn about AeroLink Ghana — Accra's premier chauffeured airport transfer service. Founded at Burma Camp, serving Kotoka International with world-class standards.",
  openGraph: {
    title: "About AeroLink Ghana | World-Class Airport Transfers",
    description:
      "Accra's premier chauffeured airport transfer service — intelligent flight tracking, fixed fares, and twenty-four-hour concierge support.",
    images: [{ url: IMAGES.meetGreet, width: 1200, height: 630, alt: "AeroLink Ghana chauffeur service" }],
  },
});
    ...
    <>
        ...
        <section className="relative flex min-h-[60vh] items-end overflow-hidden">
          <Image
            ...
            alt="AeroLink Ghana professional chauffeur service"
            fill
            priority
        ...
        <section className="py-24 sm:py-32">
          <div className="mx-auto grid max-w-7xl gap-16 px-4 sm:px-6 lg:grid-cols-2 lg:items-center">
            ...
            <div className="relative aspect-[4/5] overflow-hidden">
              <Image
                src={IMAGES.hero}
                alt="Premium airport transfer at Kotoka International"
                fill
                className="object-cover"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mx-auto mb-12 max-w-2xl text-center">
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/75">
                Every journey is backed by licensed chauffeurs, insured vehicles,
                and transparent fixed pricing — the standards international
                travellers expect.
              </p>
            </div>
        ...
        <section className="bg-navy py-16 text-center sm:py-20">
          <div className="mx-auto max-w-2xl px-4">
            <h2 className="font-display text-2xl font-bold text-white sm:text-3xl">
              Experience the AeroLink difference
            </h2>
            <p className="mt-4 text-sm text-white/70">
              Reserve your chauffeured transfer today — fixed fare, flight-tracked, flawlessly executed.
            </p>
