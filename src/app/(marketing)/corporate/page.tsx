...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "Corporate airport transfer accounts, hotel partnerships, and event logistics across Accra. Dedicated account management, consolidated billing, and priority dispatch.",
  openGraph: {
    title: "Corporate Transport Solutions | AeroLink Ghana",
    description:
      "Dedicated corporate accounts, hotel partnerships, and delegation logistics from Kotoka International Airport.",
    images: [{ url: IMAGES.fleet.suv, width: 1200, height: 630, alt: "AeroLink corporate fleet" }],
  },
});
    ...
    <>
        <section className="relative flex min-h-[55vh] items-end overflow-hidden">
          <Image
            ...
            alt="AeroLink corporate premium SUV fleet"
            fill
            priority
