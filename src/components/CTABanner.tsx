    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 text-center sm:px-6 sm:py-28">
        ...
        <p className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-white/70">
          Obtain a fixed fare in seconds. Pay securely online, confirm via
          WhatsApp, or pay your chauffeur on arrival. Complimentary
          cancellation up to forty-eight hours before pickup.
        </p>
        <Link
          href="/book"
