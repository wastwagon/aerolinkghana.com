        ...
        {showHeader && (
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <h2 className="font-display mt-4 text-3xl font-bold tracking-tight text-navy sm:text-4xl lg:text-5xl">
              ...
              <br />
              <span className="text-light-blue">across Greater Accra</span>
            </h2>
            <p className="mt-5 text-base leading-relaxed text-muted">
              From Kotoka International Airport to hotels, residences, and business
              districts — private transfers with flight tracking, meet-and-greet,
              and fixed transparent pricing.
            </p>
          </div>
        )}
