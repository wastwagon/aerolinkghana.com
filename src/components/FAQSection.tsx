          ...
          {showHeader ? (
            <div className="lg:col-span-2">
              ...
              <p className="mt-4 text-sm leading-relaxed text-muted">
                Everything you need to know about reserving a chauffeured transfer
                with AeroLink Ghana.
              </p>
              <a
                href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? "233555207204"}`}
                target="_blank"
            ...
            <div className="lg:col-span-2">
              <p className="text-sm leading-relaxed text-muted">
                Can&apos;t find what you&apos;re looking for? Our concierge team
                is available on WhatsApp twenty-four hours a day.
              </p>
              <a
                href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? "233555207204"}`}
                target="_blank"
