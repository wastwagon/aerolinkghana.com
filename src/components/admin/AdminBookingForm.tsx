  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <h1 className="font-display mt-3 text-2xl font-bold text-navy sm:text-3xl">
            {mode === "create" ? "New Booking" : `Edit ${initial?.reference}`}
          </h1>
          <p className="mt-1 text-sm text-muted">
            {mode === "create"
              ? "Create a reservation for phone, walk-in, or corporate clients"
              : "Update transfer details, status, and internal notes"}
          </p>
        </div>
      ...
      <section className="border border-border bg-white p-6 shadow-sm">
        <h2 className="font-display text-lg font-bold text-navy">Transfer details</h2>
        <div className="mt-6 grid gap-5 sm:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Optional — e.g. BA078"
              className={fieldClass}
            />
          </div>
          <div>
      ...
      <section className="border border-border bg-white p-6 shadow-sm">
        ...
        <div className="mt-5">
          ...
          <textarea
            ...
            rows={3}
            placeholder="Driver assignment, VIP handling, payment notes…"
            className={fieldClass}
          />
        </div>
        {mode === "create" && (
