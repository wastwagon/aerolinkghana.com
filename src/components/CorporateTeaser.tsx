      ...
      <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
        <div className="relative min-h-[320px] lg:min-h-[480px]">
          <Image
            ...
            alt="AeroLink corporate delegation transport"
            fill
        ...
        <div className="flex flex-col justify-center px-6 py-16 sm:px-12 lg:px-16">
          ...
          <h2 className="font-display mt-4 text-3xl font-bold text-white sm:text-4xl">
            Transportation solutions for discerning organisations
          </h2>
          <p className="mt-5 text-sm leading-relaxed text-white/75 sm:text-base">
            Dedicated account management, consolidated billing, and priority
            dispatch for corporations, hotels, and event planners. Download our
            corporate brochure or submit an enquiry today.
          </p>
