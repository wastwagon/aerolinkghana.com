      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mx-auto mb-16 max-w-2xl text-center">
          ...
          <h2 className="font-display mt-4 text-3xl font-bold text-navy sm:text-4xl lg:text-5xl">
            Everything you need, clearly organised
          </h2>
          <p className="mt-5 text-base leading-relaxed text-muted">
            Dedicated pages for our services, fleet, destinations, and booking —
            the same professional structure trusted by leading transfer operators.
          </p>
        </div>
